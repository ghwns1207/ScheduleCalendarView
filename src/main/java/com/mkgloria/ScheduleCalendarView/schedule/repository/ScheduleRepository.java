...
public interface ScheduleRepository extends JpaRepository<UserScheduleEntity, Long> {
    ...
    Optional<List<UserScheduleEntity>> findAllByCheckPublicTrueAndUserEntityIdAndStartBetweenOrEndBetween(Long userId,LocalDateTime start_time, LocalDateTime  end_time, LocalDateTime start_time2, LocalDateTime end_time2);
